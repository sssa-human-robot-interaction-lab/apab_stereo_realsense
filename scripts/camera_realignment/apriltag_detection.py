...
parser = argparse.ArgumentParser("apriltag_detection")

parser.add_argument(
    "--datapath", type=str, help="location of the camera data"
)
parser.add_argument("--camera_id", type=str, help="id of the camera (Realsense serial number)")
parser.add_argument(
    "--record",
    action="store_true",
    default=False,
...
def main():
    ...
    # select specific camera via serial number
    config.enable_device(args.camera_id)
    ...
    export_path = args.datapath + "realignment_camera_" + str(args.camera_id)

    # path to this file
    this_path = os.path.abspath(os.path.dirname(__file__))

    with open(os.path.join(this_path, "test_info.yaml"), "r") as stream:
